      ...
      >
        ...
        {isCompleted ? (
          ...
          <div className="pointer-events-none select-none flex flex-col items-center space-y-1">
            ...
            <div className="mt-6 flex flex-col items-center gap-1 px-4 py-2 rounded-2xl bg-black/20 border border-white/5 backdrop-blur-sm min-w-[120px]">
              <span className="text-[10px] text-amber-100/60 font-medium">رصيدك الشخصي</span>
              <span className="font-mono font-bold text-amber-400 text-3xl drop-shadow-sm">{personalCount}</span>
            </div>
          </div>
        )}
      </button>
